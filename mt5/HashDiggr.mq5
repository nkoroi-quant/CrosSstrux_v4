//+------------------------------------------------------------------+
//|         HashDiggr_MTF_Optimized_v11.3.mq5                       |
...
#property link      "https://github.com/nkoroi-quant/CrosSstrux_HashDiggr"
...
input string AssetName              = "BTCUSD";
input long   MagicNumber            = 260326;
...
// ========================= LOG =========================
void Log(string msg) { Print("[HashDiggr] ", msg); }
...
int WebRequestWithRetry(string method, string url, string body, string &result[])
{
...
void CreatePanel()
{
   ...
   ObjectSetString(panelChartID, PanelPrefix+"Title", OBJPROP_TEXT, "HashDiggr v12.0");
...
int OnInit()
{
   ...
   Log("HashDiggr MTF optimized v12.0 initialized successfully");
